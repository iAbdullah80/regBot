...
userName.send_keys("")  # enter ur username and send it to the textbox
pas = driver.find_element(By.XPATH, '//*[@id="PIN"]/input')  # find the password textbox by its xpath
pas.send_keys("")  # enter ur password and send it to the textbox
